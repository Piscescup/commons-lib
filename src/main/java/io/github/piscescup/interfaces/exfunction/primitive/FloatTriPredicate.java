...
/**
 * Represents a predicate (boolean-valued function) of three {@code float}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(float, float, float)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
...
public interface FloatTriPredicate {
     ...
     */
    boolean test(float x1, float x2, float x3);
