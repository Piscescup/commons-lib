 ...
 * whose functional method is {@link #applyAsFloat(Object, Object, Object, Object)}.
 *
 ...
 */
@FunctionalInterface
public interface ToFloatQuadFunction<X1, X2, X3, X4> {
    /**
     ...
     */
    float applyAsFloat(X1 x1, X2 x2, X3 x3, X4 x4);
