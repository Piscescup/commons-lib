...
/**
 * Represents a predicate (boolean-valued function) of five {@code byte}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(byte, byte, byte, byte, byte)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
@FunctionalInterface
public interface ByteQuinPredicate {
     ...
     */
    boolean test(byte x1, byte x2, byte x3, byte x4, byte x5);
     ...
     */
    default ByteQuinPredicate and(ByteQuinPredicate other) {
     ...
     */
    default ByteQuinPredicate negate() {
        return (x1, x2, x3, x4, x5) ->
            !test(x1, x2, x3, x4, x5);
    }
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default ByteQuinPredicate or(ByteQuinPredicate other) {
        NullCheck.requireNonNull(other);
        return (x1, x2, x3, x4, x5) ->
            test(x1, x2, x3, x4, x5) || other.test(x1, x2, x3, x4, x5);
    }
