 ...
 */
@FunctionalInterface
public interface ObjDoubleToObjFunction<X, Y> {
     ...
     */
    default <V> ObjDoubleToObjFunction<X, V> andThen(
     ...
     */
    default Function<X, DoubleFunction<Y>> curried() {
     ...
     */
    default ObjDoubleToObjFunction<X, Y> memorized() {
        if (isMemorized()) return this;

        final Map<BinEntry<X, Double>, Y> cache = new ConcurrentHashMap<>();
        return (ObjDoubleToObjFunction<X, Y> & Memorized) (x, value) -> {
     ...
     */
    static <X, Y> ObjDoubleToObjFunction<X, Y> constant(Y constant) {
     ...
     */
    static <X, Y> ObjDoubleToObjFunction<X, Y> of(
        ObjDoubleToObjFunction<X, Y> function
    ) {
    ...
    static <X, Y> ObjDoubleToObjFunction<X, Y> narrow(
        ObjDoubleToObjFunction<? super X, ? extends Y> function
    ) {
        NullCheck.requireNonNull(function);
        return (ObjDoubleToObjFunction<X, Y>) function;
    }
}
