...
import io.github.piscescup.interfaces.exfunction.primitive.ByteConsumer;
 ...
 * {@code byte}-valued argument and returns no result.
 *
 ...
 */
@FunctionalInterface
public interface ObjByteConsumer<X> {
     ...
     */
    default ByteConsumer accept(X x) {
     ...
     */
    default ObjByteConsumer<X> andThen(ObjByteConsumer<? super X> after) {
     ...
     */
    default Function<X, ByteConsumer> curried() {
     ...
     */
    static <X> ObjByteConsumer<X> empty() {
        return (x, value) -> {};
    }
     ...
     */
    static <X> ObjByteConsumer<X> of(ObjByteConsumer<X> consumer) {
    ...
    static <X> ObjByteConsumer<X> narrow(
        ObjByteConsumer<? super X> consumer
    ) {
        NullCheck.requireNonNull(consumer);
        return (ObjByteConsumer<X>) consumer;
    }
     ...
     *         {@code null}
     */
    static <X> @NotNull ObjByteConsumer<X> schedule(
        Collection<? extends ObjByteConsumer<? super X>> consumers
    ) {
        ...
        return (x, value) -> {
            for (ObjByteConsumer<? super X> consumer : consumers) {
