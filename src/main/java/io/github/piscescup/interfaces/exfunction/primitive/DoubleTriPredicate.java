...
/**
 * Represents a predicate (boolean-valued function) of three {@code double}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(double, double, double)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
...
public interface DoubleTriPredicate {
     ...
     */
    boolean test(double x1, double x2, double x3);
