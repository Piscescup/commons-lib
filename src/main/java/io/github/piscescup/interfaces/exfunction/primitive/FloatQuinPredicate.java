...
/**
 * Represents a predicate (boolean-valued function) of five {@code float}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(float, float, float, float, float)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
@FunctionalInterface
public interface FloatQuinPredicate {
     ...
     */
    boolean test(float x1, float x2, float x3, float x4, float x5);
     ...
     */
    default FloatQuinPredicate and(FloatQuinPredicate other) {
     ...
     */
    default FloatQuinPredicate negate() {
        return (x1, x2, x3, x4, x5) ->
            !test(x1, x2, x3, x4, x5);
    }
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default FloatQuinPredicate or(FloatQuinPredicate other) {
        NullCheck.requireNonNull(other);
        return (x1, x2, x3, x4, x5) ->
            test(x1, x2, x3, x4, x5) || other.test(x1, x2, x3, x4, x5);
    }
