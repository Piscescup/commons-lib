 ...
 * the {@code char} type. This is a specialization of {@link CharQuadFunction} where the
 ...
 */
@FunctionalInterface
public interface CharQuadOperator {
     ...
     */
    char applyAsChar(char a, char b, char c, char d);
}
