...
/**
 * Represents a function that accepts four char-valued arguments and produces a
 * result. This is the {@code char}-consuming primitive specialization for
 * {@link QuadFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #apply(char, char, char, char)}.
 *
 ...
 */
@FunctionalInterface
public interface CharQuadFunction<R> {
     ...
     */
    R apply(char value1, char value2, char value3, char value4);
}
