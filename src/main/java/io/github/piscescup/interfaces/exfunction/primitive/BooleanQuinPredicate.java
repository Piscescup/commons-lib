...
/**
 * Represents a predicate (boolean-valued function) of five {@code boolean}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(boolean, boolean, boolean, boolean, boolean)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
@FunctionalInterface
public interface BooleanQuinPredicate {
     ...
     */
    boolean test(boolean x1, boolean x2, boolean x3, boolean x4, boolean x5);
     ...
     */
    default BooleanQuinPredicate and(BooleanQuinPredicate other) {
     ...
     */
    default BooleanQuinPredicate negate() {
        return (x1, x2, x3, x4, x5) ->
            !test(x1, x2, x3, x4, x5);
    }
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default BooleanQuinPredicate or(BooleanQuinPredicate other) {
        NullCheck.requireNonNull(other);
        return (x1, x2, x3, x4, x5) ->
            test(x1, x2, x3, x4, x5) || other.test(x1, x2, x3, x4, x5);
    }
