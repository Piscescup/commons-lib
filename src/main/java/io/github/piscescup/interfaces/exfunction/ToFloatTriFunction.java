 ...
 * whose functional method is {@link #applyAsFloat(Object, Object, Object)}.
 *
 ...
 */
@FunctionalInterface
public interface ToFloatTriFunction<X1, X2, X3> {
     ...
     */
    float applyAsFloat(X1 x1, X2 x2, X3 x3);
