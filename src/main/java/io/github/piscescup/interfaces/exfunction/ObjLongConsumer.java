 ...
 * {@code long}-valued argument and returns no result.
 *
 ...
 */
@FunctionalInterface
public interface ObjLongConsumer<X>
    extends java.util.function.ObjLongConsumer<X> {
     ...
     */
    default LongConsumer accept(X x) {
     ...
     */
    default ObjLongConsumer<X> andThen(ObjLongConsumer<? super X> after) {
     ...
     */
    default Function<X, LongConsumer> curried() {
     ...
     */
    static <X> ObjLongConsumer<X> empty() {
        return (x, value) -> {};
    }
     ...
     */
    static <X> ObjLongConsumer<X> of(ObjLongConsumer<X> consumer) {
    ...
    static <X> ObjLongConsumer<X> narrow(
        ObjLongConsumer<? super X> consumer
    ) {
        NullCheck.requireNonNull(consumer);
        return (ObjLongConsumer<X>) consumer;
    }
     ...
     *         {@code null}
     */
    static <X> @NotNull ObjLongConsumer<X> schedule(
        Collection<? extends ObjLongConsumer<? super X>> consumers
    ) {
        ...
        return (x, value) -> {
            for (ObjLongConsumer<? super X> consumer : consumers) {
