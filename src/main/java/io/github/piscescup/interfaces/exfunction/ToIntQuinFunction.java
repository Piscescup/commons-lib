...
/**
 * Represents a function that accepts five arguments and produces an {@code int}-valued result.
 *
 * <p>This is the {@code int}-producing primitive specialization for {@link QuinFunction}.
 *
 ...
 */
@FunctionalInterface
public interface ToIntQuinFunction<X1, X2, X3, X4, X5> {
     ...
     */
    int applyAsInt(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5);
     ...
     */
    default Integer boxedApply(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5) {
        ...
        return applyAsInt(x1, x2, x3, x4, x5);
    }
}