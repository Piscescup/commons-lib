...
/**
 * Represents a function that accepts four float-valued arguments and produces a
 * result. This is the {@code float}-consuming primitive specialization for
 * {@link QuadFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #apply(float, float, float, float)}.
 *
 ...
 */
@FunctionalInterface
public interface FloatQuadFunction<R> {
     ...
     */
    R apply(float value1, float value2, float value3, float value4);
}
