 ...
 * {@code double}-valued argument.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(Object, double)}.
 *
 ...
 */
@FunctionalInterface
public interface ObjDoublePredicate<X> {
     ...
     */
    default DoublePredicate test(X x) {
     ...
     */
    default ObjDoublePredicate<X> and(ObjDoublePredicate<? super X> other) {
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default ObjDoublePredicate<X> or(ObjDoublePredicate<? super X> other) {
        NullCheck.requireNonNull(other);
        return (x, value) -> test(x, value) || other.test(x, value);
    }
     ...
     */
    default ObjDoublePredicate<X> negate() {
     ...
     */
    default Function<X, DoublePredicate> curried() {
        return x -> value -> test(x, value);
    }
     ...
     */
    default ObjDoublePredicate<X> memorized() {
        if (isMemorized()) return this;

        final Map<BinEntry<X, Double>, Boolean> cache =
            new ConcurrentHashMap<>();

        return (ObjDoublePredicate<X> & Memorized) (x, value) -> {
     ...
     */
    static <X> ObjDoublePredicate<X> always() {
        return (x, value) -> true;
    }
     ...
     */
    static <X> ObjDoublePredicate<X> never() {
    ...
    static <X> ObjDoublePredicate<X> narrow(
        ObjDoublePredicate<? super X> predicate
    ) {
        NullCheck.requireNonNull(predicate);
        return (ObjDoublePredicate<X>) predicate;
    }
}
