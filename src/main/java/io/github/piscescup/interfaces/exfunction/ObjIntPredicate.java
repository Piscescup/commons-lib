 ...
 * {@code int}-valued argument.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(Object, int)}.
 *
 ...
 */
@FunctionalInterface
public interface ObjIntPredicate<X> {
     ...
     */
    default ObjIntPredicate<X> and(ObjIntPredicate<? super X> other) {
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default ObjIntPredicate<X> or(ObjIntPredicate<? super X> other) {
        NullCheck.requireNonNull(other);
        return (x, value) -> test(x, value) || other.test(x, value);
    }
     ...
     */
    default ObjIntPredicate<X> negate() {
     ...
     */
    default Function<X, IntPredicate> curried() {
        return x -> value -> test(x, value);
    }
     ...
     */
    default ObjIntPredicate<X> memorized() {
        if (isMemorized()) return this;

        final Map<BinEntry<X, Integer>, Boolean> cache =
            new ConcurrentHashMap<>();

        return (ObjIntPredicate<X> & Memorized) (x, value) -> {
     ...
     */
    static <X> ObjIntPredicate<X> always() {
        return (x, value) -> true;
    }
     ...
     */
    static <X> ObjIntPredicate<X> never() {
    ...
    static <X> ObjIntPredicate<X> narrow(
        ObjIntPredicate<? super X> predicate
    ) {
        NullCheck.requireNonNull(predicate);
        return (ObjIntPredicate<X>) predicate;
    }
}
