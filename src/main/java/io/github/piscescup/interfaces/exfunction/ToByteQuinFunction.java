...
/**
 * Represents a function that accepts five arguments and produces a {@code byte}-valued result.
 *
 * <p>This is the {@code byte}-producing primitive specialization for {@link QuinFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #applyAsByte(Object, Object, Object, Object, Object)}.
 *
 ...
 */
@FunctionalInterface
public interface ToByteQuinFunction<X1, X2, X3, X4, X5> {
     ...
     */
    byte applyAsByte(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5);
     ...
     */
    default Byte boxedApply(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5) {
        ...
        return applyAsByte(x1, x2, x3, x4, x5);
    }
}