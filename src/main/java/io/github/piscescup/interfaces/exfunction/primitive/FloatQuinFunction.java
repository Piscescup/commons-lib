...
/**
 * Represents a function that accepts five float-valued arguments and produces a
 * result. This is the {@code float}-consuming primitive specialization for
 * {@link QuinFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #apply(float, float, float, float, float)}.
 *
 * @see QuinFunction
 ...
 * @since 1.1.0
 */
public interface FloatQuinFunction <R> {
     ...
     */
    R apply(float value1, float value2, float value3, float value4, float value5);
}
