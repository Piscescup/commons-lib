...
/**
 * Represents a predicate (boolean-valued function) of four {@code byte}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(byte, byte, byte, byte)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
@FunctionalInterface
public interface ByteQuadPredicate {
     ...
     */
    boolean test(byte x1, byte x2, byte x3, byte x4);
     ...
     */
    default ByteQuadPredicate and(ByteQuadPredicate other) {
     ...
     */
    default ByteQuadPredicate negate() {
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default ByteQuadPredicate or(ByteQuadPredicate other) {
        NullCheck.requireNonNull(other);
        return (x1, x2, x3, x4) -> test(x1, x2, x3, x4) || other.test(x1, x2, x3, x4);
    }
}