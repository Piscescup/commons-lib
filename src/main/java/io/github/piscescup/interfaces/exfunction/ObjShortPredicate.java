...
import io.github.piscescup.interfaces.exfunction.primitive.ShortPredicate;
 ...
 * {@code short}-valued argument.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(Object, short)}.
 *
 ...
 */
@FunctionalInterface
public interface ObjShortPredicate<X> {
     ...
     */
    default ShortPredicate test(X x) {
     ...
     */
    default ObjShortPredicate<X> and(ObjShortPredicate<? super X> other) {
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default ObjShortPredicate<X> or(ObjShortPredicate<? super X> other) {
        NullCheck.requireNonNull(other);
        return (x, value) -> test(x, value) || other.test(x, value);
    }
     ...
     */
    default ObjShortPredicate<X> negate() {
     ...
     */
    default Function<X, ShortPredicate> curried() {
        return x -> value -> test(x, value);
    }
     ...
     */
    default ObjShortPredicate<X> memorized() {
        if (isMemorized()) return this;

        final Map<BinEntry<X, Short>, Boolean> cache =
            new ConcurrentHashMap<>();

        return (ObjShortPredicate<X> & Memorized) (x, value) -> {
     ...
     */
    static <X> ObjShortPredicate<X> always() {
        return (x, value) -> true;
    }
     ...
     */
    static <X> ObjShortPredicate<X> never() {
    ...
    static <X> ObjShortPredicate<X> narrow(
        ObjShortPredicate<? super X> predicate
    ) {
        NullCheck.requireNonNull(predicate);
        return (ObjShortPredicate<X>) predicate;
    }
}
