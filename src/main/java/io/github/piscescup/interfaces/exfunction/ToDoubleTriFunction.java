...
/**
 * Represents a function that accepts three arguments and produces a {@code double}-valued result.
 *
 * <p>This is the {@code double}-producing primitive specialization for {@link TriFunction}.
 *
 ...
 */
@FunctionalInterface
public interface ToDoubleTriFunction<X1, X2, X3> {
     ...
     */
    double applyAsDouble(X1 x1, X2 x2, X3 x3);
