...
/**
 * Represents a function that accepts four arguments and produces a {@code long}-valued result.
 *
 * <p>This is the {@code long}-producing primitive specialization for {@link QuadFunction}.
 *
 ...
 */
@FunctionalInterface
public interface ToLongQuadFunction<X1, X2, X3, X4> {
     ...
     */
    long applyAsLong(X1 x1, X2 x2, X3 x3, X4 x4);
