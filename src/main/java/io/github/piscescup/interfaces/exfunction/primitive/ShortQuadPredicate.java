...
/**
 * Represents a predicate (boolean-valued function) of four {@code short}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(short, short, short, short)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
@FunctionalInterface
public interface ShortQuadPredicate {
     ...
     */
    boolean test(short x1, short x2, short x3, short x4);
     ...
     */
    default ShortQuadPredicate and(ShortQuadPredicate other) {
     ...
     */
    default ShortQuadPredicate negate() {
        return (x1, x2, x3, x4) ->
            !test(x1, x2, x3, x4);
    }
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default ShortQuadPredicate or(ShortQuadPredicate other) {
        NullCheck.requireNonNull(other);
        return (x1, x2, x3, x4) ->
            test(x1, x2, x3, x4) || other.test(x1, x2, x3, x4);
    }
