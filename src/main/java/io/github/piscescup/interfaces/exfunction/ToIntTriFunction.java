...
/**
 * Represents a function that accepts three arguments and produces an {@code int}-valued result.
 *
 * <p>This is the {@code int}-producing primitive specialization for {@link TriFunction}.
 *
 ...
 */
@FunctionalInterface
public interface ToIntTriFunction<X1, X2, X3> {
     ...
     */
    int applyAsInt(X1 x1, X2 x2, X3 x3);
