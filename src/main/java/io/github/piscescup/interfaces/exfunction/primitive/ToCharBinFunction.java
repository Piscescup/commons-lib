 ...
 *
 * <p>This is the {@code char}-producing primitive specialization for {@link BinFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #applyAsChar(Object, Object)}.
 *
 ...
 */
@FunctionalInterface
public interface ToCharBinFunction<X1, X2> {
     ...
     */
    default Character boxedApply(X1 x1, X2 x2) {
        NullCheck.requireNonNull(x1);
        NullCheck.requireNonNull(x2);
        return applyAsChar(x1, x2);
    }
}