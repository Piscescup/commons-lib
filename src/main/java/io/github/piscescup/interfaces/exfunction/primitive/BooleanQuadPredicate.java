...
/**
 * Represents a predicate (boolean-valued function) of four {@code boolean}-valued arguments.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(boolean, boolean, boolean, boolean)}.</p>
 *
 * @author REN YuanTong
 * @since 1.1.0
 */
@FunctionalInterface
public interface BooleanQuadPredicate {
     ...
     */
    boolean test(boolean x1, boolean x2, boolean x3, boolean x4);
     ...
     */
    default BooleanQuadPredicate and(BooleanQuadPredicate other) {
     ...
     */
    default BooleanQuadPredicate negate() {
        return (x1, x2, x3, x4) ->
            !test(x1, x2, x3, x4);
    }
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default BooleanQuadPredicate or(BooleanQuadPredicate other) {
        NullCheck.requireNonNull(other);
        return (x1, x2, x3, x4) ->
            test(x1, x2, x3, x4) || other.test(x1, x2, x3, x4);
    }
