...
import io.github.piscescup.interfaces.exfunction.primitive.BytePredicate;
 ...
 * {@code byte}-valued argument.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #test(Object, byte)}.
 *
 ...
 */
@FunctionalInterface
public interface ObjBytePredicate<X> {
     ...
     */
    default BytePredicate test(X x) {
     ...
     */
    default ObjBytePredicate<X> and(ObjBytePredicate<? super X> other) {
     ...
     * @throws NullPointerException if {@code other} is {@code null}
     */
    default ObjBytePredicate<X> or(ObjBytePredicate<? super X> other) {
        NullCheck.requireNonNull(other);
        return (x, value) -> test(x, value) || other.test(x, value);
    }
     ...
     */
    default ObjBytePredicate<X> negate() {
     ...
     */
    default Function<X, BytePredicate> curried() {
        return x -> value -> test(x, value);
    }
     ...
     */
    default ObjBytePredicate<X> memorized() {
        if (isMemorized()) return this;

        final Map<BinEntry<X, Byte>, Boolean> cache =
            new ConcurrentHashMap<>();

        return (ObjBytePredicate<X> & Memorized) (x, value) -> {
     ...
     */
    static <X> ObjBytePredicate<X> always() {
        return (x, value) -> true;
    }
     ...
     */
    static <X> ObjBytePredicate<X> never() {
    ...
    static <X> ObjBytePredicate<X> narrow(
        ObjBytePredicate<? super X> predicate
    ) {
        NullCheck.requireNonNull(predicate);
        return (ObjBytePredicate<X>) predicate;
    }
}
