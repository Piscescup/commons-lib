...
/**
 * Represents a function that accepts five arguments and produces a {@code long}-valued result.
 *
 * <p>This is the {@code long}-producing primitive specialization for {@link QuinFunction}.
 *
 ...
 */
@FunctionalInterface
public interface ToLongQuinFunction<X1, X2, X3, X4, X5> {
     ...
     */
    long applyAsLong(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5);
     ...
     */
    default Long boxedApply(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5) {
        ...
        return applyAsLong(x1, x2, x3, x4, x5);
    }
}